...
<head>
  ...
  <title>Vignan's Etude-A Smart Wat Of Learning</title>
  <meta charset="utf-8">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#faculty">UPLOAD MATERIALS</a></li>
        <li><a href="#contact">UPLOAD RESEARCH PAPERS</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
        <form><input type="button" onclick=""></form>
    </div>
...
<div id="student" class="container-fluid text-center">
  <h2>STUDENT</h2>
  <br>
  <br><br><br>
  <center><div class="row slideanim">

  <input type="button" value="Login" class="btn btn-lg">
  <input type="button" value="Sign Up" class="btn btn-lg">>
    </div>
...
Vadlamudi, Guntur-522213</p>
      ...
      <p><span class="glyphicon glyphicon-envelope"></span>  info@vignanuniversity.org</p>
    </div></center>
    </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu-916DdpKAjTmJNIgngS6HL_kDIKU0aU&callback=myMa"></script>
<!--
