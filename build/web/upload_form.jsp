            ...
            <br>
                   <table >
                        <tr>
                           ...
                           <td> <input type="text" name="empid" class="text" placeholder="Employee Id"  style="width: 230px;"></td>
                       </tr>
                       <tr>
                      <tr>

<td>      <label for="departments"><b>Department:</b></label></td>

      <td><select name="departments" style="width: 230px;">
      ...
      <option value="PHARMACEUTICAL SCIENCES">PHARMACEUTICAL SCIENCES</option>
                       ...
                       <tr>
                           ...
                           <td> <input type="text" name="title" class="text" placeholder="Subject Name"  style="width: 230px;"></td>
                       </tr>
