				...
				<div class="sidebar-background" style="background-color:rgba(81,191,69,0.98)">
					...
					<div class="left-menu">
						<a  href="std-page.jsp?pgprt=0"><h2>Profile</h2></a>
                                                <a href="std-page.jsp?pgprt=3"><h2>View Materials</h2></a>
						<a class="active" href="std-page.jsp?pgprt=1"><h2>Take Exam</h2></a>
       ...
       <br/>
        ...
        <% 
         ...
         Statement stmt=con.createStatement();
            ResultSet rs =stmt.executeQuery("SELECT * from student_registration where regno='"+username+"' ");
            while(rs.next())
            {
            String department=rs.getString("Department");
            ArrayList list1=pDAO.getAllSCourses(department);
